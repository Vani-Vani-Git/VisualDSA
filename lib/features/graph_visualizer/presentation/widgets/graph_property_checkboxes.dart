...
// Only 3 options: Weighted, Directed, Connected
// "Connected" means undirected-connected (no Cyclic/Loop options)
class GraphPropertyCheckboxes extends StatelessWidget {
  final GraphProperties props;
  final void Function(GraphProperties) onChanged;

  const GraphPropertyCheckboxes({
    super.key,
    required this.props,
  ...
  Widget build(BuildContext context) {
    // Three items only
    final items = <(String, bool, GraphProperties Function(bool))>[
