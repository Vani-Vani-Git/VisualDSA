...
class SpAnimControls extends StatelessWidget {
  final bool playing;
  final bool finished;
  final int stepIndex;
  ...
  final String? iterationLabel; // e.g. "Iteration 2/4" for Bellman-Ford
